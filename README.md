...
```bash
helm install my-release https://github.com/kubeshop/monokle-admission-controller/releases/download/v0.1.0/helm.tgz --set automationToken=YOUR_AUTOMATION_TOKEN
```
...
```bash
kubectl apply -f https://github.com/kubeshop/monokle-admission-controller/releases/download/v0.1.0/install-cloud.yaml
```
...
```bash
kubectl apply -f https://github.com/kubeshop/monokle-admission-controller/releases/download/v0.1.0/install-standalone.yaml
```
