...
```bash
helm install my-release https://github.com/kubeshop/monokle-admission-controller/releases/download/v0.2.1/helm.tgz --set automationToken=YOUR_AUTOMATION_TOKEN
```
...
```bash
kubectl apply -f https://github.com/kubeshop/monokle-admission-controller/releases/download/v0.2.1/install-cloud.yaml
```
...
```bash
helm install my-release https://github.com/kubeshop/monokle-admission-controller/releases/download/v0.2.1/helm.tgz
```
...
```bash
kubectl apply -f https://github.com/kubeshop/monokle-admission-controller/releases/download/v0.2.1/install-standalone.yaml
```
